...
<div class="boxed_wrapper">
                            ...
                            <nav class="main-menu style1 navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        <li><a href="/">Оставить чаевые</a></li>
    ...
    <section class="donate-style1-area mt-5">
        <div class="container pt-5">
            <div class="title text-center">
                <h2>Чаевые отправлены!</h2>
            </div>
            <h3 class="text-center">Хотите оставить отзыв?</h3>
            <div class="row cart-button-box justify-content-center py-5">
                <div class="apply-coupon">
                    ...
                    <form action="comment" id="donate-form-style1" method="post" name="donate_form_style1">
                        @csrf
                        <div class="inner">
                            <input type="hidden" name="tip_id" value="{{ $tip_id ?? null }}">
