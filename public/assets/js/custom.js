...
// Main Slider Carousel
if ($('.about-style2-carousel').length) {
    $('.about-style2-carousel').owlCarousel({
        stagePadding: 0,
        loop: true,
        margin: 0,
        dots: true,
...
if ($('.bio-carousel .content-carousel').length && $('.bio-carousel .thumbs-carousel').length) {
    var $sync3 = $(".bio-carousel .content-carousel"),
        $sync4 = $(".bio-carousel .thumbs-carousel"),
        flags = false,
        durations = 500;
